    ...
    <section className="min-h-[100vh] px-[5%] py-8 bg-[#eee] flex flex-col lg:flex-row justify-center lg:justify-around items-center gap-12">
      <div className="grid gap-7">
        ...
        <div className="flex justify-center gap-5">
          <Link>
            <img src={facebook} className="h-9 lg:h-10" />
          </Link>
          <Link>
            <img src={instagram} className="h-9 lg:h-10" />
          </Link>
          <Link>
            <img src={whatsapp} className="h-9 lg:h-10" />
          </Link>
          <Link>
            <img src={telegram} className="h-9 lg:h-10" />
          </Link>
        </div>
      </div>
      <p className="w-full lg:w-1/2 xl:w-[40%] text-xl">
